...
@section('content')
    <div class="container">
      ...
      <section class="content">
        ...
        <form action="{{ route('proses-validasi-kadin',$item->id) }}" method="post">
            @csrf
                ...
                <!-- form start -->
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="nik" class="form-control" id="nik" value="{{$item->nik}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="alamat_rumah" class="form-control" id="alamat_rumah" value="{{$item->alamat_rumah}}">
                    </div>
                    <div class="form-group">
                        <label for="npwpd">NPWPD</label>
                        <input type="text" name="npwpd" class="form-control" id="npwpd" value="{{$item->npwpd}}">
                      </div>
                    <div class="form-group">
                      <label for="nama_perusahaan">Nama Perusahaan</label>
                      <input type="text" name="nama_perusahaan" class="form-control" id="nama_perusahaan" value="{{$item->nama_perusahaan}}">
                    </div>
                    <div class="form-group">
                      <label for="jenis_usaha">Jenis Usaha</label>
                      <input type="text" name="jenis_usaha" class="form-control" id="jenis_usaha" value="{{$item->jenis_usaha}}">
                    </div>
                    <div class="form-group">
                      <label for="alamat_usaha">Alamat Perusahaan</label>
                      <input type="text" name="alamat_usaha" class="form-control" id="alamat_usaha" value="{{$item->alamat_usaha}}">
                    </div>
                  </div>
                  <!-- /.card-body -->
              </div>
                ...
                <!-- form start -->
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="number" name="nominal_pajak" class="form-control" id="nominal_pajak" value="{{$item->nominal_pajak}}">
                    </div>
                    <div class="form-group">
                      <label for="nominal_ujb">nominal jasa bongkar</label>
                      <input type="number" name="nominal_ujb" class="form-control" id="nominal_ujb" value="{{$item->nominal_ujb}}">
                    </div>
                  </div>
                  <!-- /.card-body -->
              </div>
                ...
                <!-- form start -->
                  <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="tipe_reklame" class="form-control" id="tipe_reklame" value="{{$item->tipe_reklame}}">
                      </div>
                    <div class="form-group">
                      <label for="jenis_reklame">Jenis Reklame</label>
                      <input type="text" name="jenis_reklame" class="form-control" id="jenis_reklame" value="{{$item->jenis_reklame}}">
                    </div>
                    <div class="form-group">
                      <label for="bunyi_reklame">Bunyi Reklame</label>
                      <input type="text" name="bunyi_reklame" class="form-control" id="bunyi_reklame" value="{{$item->bunyi_reklame}}">
                    </div>
                    <div class="form-group">
                      <label for="ukuran_reklame">Ukuran Panjang & Lebar & Muka</label>
                      <input type="text" name="ukuran_reklame" class="form-control" id="ukuran_reklame" value="{{$item->ukuran_reklame}}">
                    </div>
                    <div class="form-group">
                      <label for="tempat_pasang_reklame">Tempat Pasang</label>
                      <input type="text" name="tempat_pasang_reklame" class="form-control" id="tempat_pasang_reklame" value="{{$item->tempat_pasang_reklame}}">
                    </div>
                    <div class="form-group">
                      <label for="jumlah_reklame">Jumlah reklame</label>
                      <input type="text" name="jumlah_reklame" class="form-control" id="jumlah_reklame" value="{{$item->jumlah_reklame}}">
                    </div>
                    <div class="form-group">
                      <label for="tanggal_mulai_pasang_reklame">tanggal_mulai_pasang_reklame</label>
                      <input type="date" name="tanggal_mulai_pasang_reklame" class="form-control" id="tanggal_mulai_pasang_reklame" value="{{$item->tanggal_mulai_pasang_reklame->format('Y-m-d','strtotime')}}">
                    </div>
                    <div class="form-group">
                      <label for="tanggal_akhir_pasang_reklame">tanggal_akhir_pasang_reklame</label>
                      <input type="date" name="tanggal_akhir_pasang_reklame" class="form-control" id="tanggal_akhir_pasang_reklame" value="{{$item->tanggal_akhir_pasang_reklame->format('Y-m-d','strtotime')}}">
                    </div>
                    <div class="form-group">
                        <label for="tanggal_masuk_ujb">tanggal_masuk_ujb</label>
                        <input type="date" name="tanggal_masuk_ujb" class="form-control" id="tanggal_masuk_ujb" value="{{$item->tanggal_masuk_ujb->format('Y-m-d','strtotime')}}">
                      </div>
                  </div>
                  <!-- /.card-body -->
              </div>
