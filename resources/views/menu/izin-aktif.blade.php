        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">List Izin Aktif</li>
                </ol>
            </nav>
        </div>
        <!-- Small boxes (Stat box) -->
...
@endphp
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('cetak-bukti-pengambilan',$item->id)}}" class="btn btn-primary">Cetak bukti pengambilan</a>
                                        @elseif (auth()->user()->level=="petugas-luar")
                                        <p>-</p>
                                        @else
